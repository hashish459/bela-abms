...
| ~~**Workshop**~~ (auto/repair) | ~~workshop job card, workshop technician~~ | **✅ built session 14** — see Docs/DATABASE.md |
...
| Workshop (Job Card, Technician, parts+labor billing) | ✓ (minimal in nav) | ✅ Job Card bills through Sales' own `createInvoice()` directly — zero new ledgers, zero duplicated GL logic — see Docs/DATABASE.md |
