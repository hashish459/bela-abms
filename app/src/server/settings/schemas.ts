...
export const receiptTemplateUpdate = z.object({
  receiptTemplate: z.enum(["CLASSIC", "MODERN", "THERMAL", "COMPACT"]),
});
...
export type ReceiptTemplateUpdate = z.infer<typeof receiptTemplateUpdate>;
